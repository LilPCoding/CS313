    ...
    <section class="py-5 text-center container">
      <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto">
          ...
          <p>
            <a href="#" class="btn btn-primary my-2" style="margin-right:3px;">Main call to action</a>
            <a href="#" class="btn btn-secondary my-2" style="margin-left:3px;">Secondary action</a>
          </p>
        </div>
      </div>
    </section>
